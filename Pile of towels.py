...
def sort_the_pile(pile_of_towels, weekly_used_towels):
    if pile_of_towels and weekly_used_towels:
        for used_towels in weekly_used_towels:
            basket = [towel for towel in pile_of_towels[ (len(pile_of_towels) - used_towels)::]]
            pile_of_towels = [towel for towel in pile_of_towels[:(len(pile_of_towels) - used_towels):]]
            basket.sort()
            basket = basket[::-1]
            pile_of_towels += [clean_towel for clean_towel in basket]
